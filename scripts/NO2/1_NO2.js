...
var pollutant_band = 'NO2'; // Razão de Mistura Volumétrica (mol/mol)
...
Map.addLayer(
    ...
    pollutant_vis,
    'GEOS-CF Dióxido de Nitrogênio (µg/m³)'
);
...
Export.image.toDrive({
    ...
    description: 'GEOS_NO2_2024', // Para anos: 'GEOS_NO2_20XX' // Para meses: 'GEOS_NO2_XX_20XX'
    scale: 28000,
