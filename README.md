...
Os _calendar heatmaps_ abaixo foram gerados a partir dos dados coletados pelos _scripts_ `4_NO2.js` e `4_O3.js`.  
O cabeçalho deste repositório foi gerado com base nas imagens _raster_ obtidas pelo _script_ `1_SO2.js`.
